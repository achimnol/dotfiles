...
execute "hi CursorLine "   . s:ColorMode . "bg=" . s:glacier.bg1[s:ArrayBit]
...
"execute "hi DiffText  "    . s:ColorMode . "fg=" . s:glacier.xterm15[s:ArrayBit] . " " . s:ColorMode . "bg=" . s:glacier.guibg[s:ArrayBit]  . " " . s:ColorMode . "=none"
